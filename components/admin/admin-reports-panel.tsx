    ...
    <div className="space-y-8">
      ...
      {bookingTotals ? (
        <section className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
          <h2 className="font-serif text-lg font-semibold text-gray-900">Booking totals</h2>
      ...
      {revenue ? (
        <>
          <section className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            <h2 className="font-serif text-lg font-semibold text-gray-900">Revenue by day (confirmed)</h2>
          ...
          <section className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            <h2 className="font-serif text-lg font-semibold text-gray-900">By tour (confirmed)</h2>
            <div className="mt-4 overflow-x-auto">
              <table className="min-w-full text-left text-sm">
                <thead className="border-b text-xs uppercase text-gray-500">
                  <tr>
                ...
                <tbody>
                  {revenue.by_tour.map((t) => (
                    <tr key={t.tour_id} className="border-b border-gray-100">
